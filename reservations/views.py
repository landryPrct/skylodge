...
def ajout_reservations(request, pk, fromdate, todate):
    ...
    ctx = {'form': form, 'reservations': reservations, 'chambre': chambre, "fromdate": fromdate, "todate": todate,
           "days": days, "categorie": categorie, "amount": amount, "latest": res_id, "total": total_to_pay}
        ...
        if form.is_valid():
            ...
            if account:
                ...
                if customer['name']:
                    ...
                    init_bill = ihela_api_bill_initiate(
                        amount, customer["account_number"], description, reference, redirect_uri=REDIRECT_URL)
